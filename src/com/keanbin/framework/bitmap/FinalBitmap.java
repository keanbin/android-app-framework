 ...
 */
package com.keanbin.framework.bitmap;
...
import com.keanbin.framework.bitmap.core.AsyncTask;
import com.keanbin.framework.bitmap.core.BitmapCache;
import com.keanbin.framework.bitmap.core.BitmapDisplayConfig;
import com.keanbin.framework.bitmap.core.BitmapProcess;
import com.keanbin.framework.bitmap.display.Displayer;
import com.keanbin.framework.bitmap.display.SimpleDisplayer;
import com.keanbin.framework.bitmap.download.Downloader;
import com.keanbin.framework.bitmap.download.SimpleDownloader;
import com.keanbin.framework.bitmap.util.Utils;
...
public class FinalBitmap {
		...
		if (TextUtils.isEmpty(uri) || imageView == null) {
			if (imageView != null) {
				...
				if (imageView instanceof ImageView) {
					((ImageView) imageView).setImageBitmap(displayConfig
							.getLoadfailBitmap());
				} else {
	...
	/**
	 * 关闭 imageView 中正在运行的线程
	 * 
	 * @param imageView
	 * @return
	 */
	public static void closeImageTask(View imageView) {
		final BitmapLoadAndDisplayTask bitmapWorkerTask = getBitmapTaskFromImageView(imageView);

		if (bitmapWorkerTask != null) {
			bitmapWorkerTask.cancel(true);
			Log.i("BitmapLoadAndDisplayTask",
					"closeImageTask bitmapWorkerTask = " + bitmapWorkerTask
							+ ", isCancelled()"
							+ bitmapWorkerTask.isCancelled());
		}
	}
	...
	private class BitmapLoadAndDisplayTask extends
		...
		protected void onPostExecute(Bitmap bitmap) {
			...
			Log.i("BitmapLoadAndDisplayTask", "onPostExecute this = " + this
