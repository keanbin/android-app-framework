 ...
 * @author kevin
 */
public class FourTabPage extends LinearLayout {
	...
	public FourTabPage(Context context) {
		super(context);
	...
	private void initView() {
		...
		View viewPage = inflater.inflate(R.layout.widget_tab_04, null);

		mTitleBar = (TitleBar) viewPage
				.findViewById(R.id.titleBar_widgetTab04_title);
		mTitleBar.setTitleText("第四页");
