 ...
 * @author kevin
 */
public class OneTabPage extends LinearLayout {
	...
	public OneTabPage(Context context) {
		super(context);
	...
	private void initView() {
		...
		View viewPage = inflater.inflate(R.layout.widget_tab_01, null);

		mTitleBar = (TitleBar) viewPage
				.findViewById(R.id.titleBar_widgetTab01_title);
		mTitleBar.setTitleText("第一页");
